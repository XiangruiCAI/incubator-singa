...
# source: caffe_parse/caffe.proto
...
BlobShape = _reflection.GeneratedProtocolMessageType('BlobShape', (_message.Message,), dict(
  ...
  __module__ = 'caffe_parse.caffe_pb2'
